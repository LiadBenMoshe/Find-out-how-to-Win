...
function moveLeft() {
  ...
  if (left > 0) {
    ...
    character.style.backgroundColor = randColor(); //randomColor();
  }
}
function moveRight() {
  var left = parseInt(
...
var blocks = setInterval(function () {
  ...
  if (drop == 0) {
    if (characterTop < 480) {
      character.style.top = characterTop + 2 + "px"; //character goes down
    }
  } else {
    character.style.top = characterTop - 0.5 + "px"; //character goes up
  }
}, 1);
